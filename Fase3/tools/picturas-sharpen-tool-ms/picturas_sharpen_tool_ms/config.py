...
RABBITMQ_REQUESTS_QUEUE_NAME = os.getenv("RABBITMQ_REQUESTS_QUEUE_NAME", "sharpen-requests")
...
PICTURAS_MS_NAME = os.getenv("PICTURAS_MS_NAME", "picturas-sharpen-tool-ms")
