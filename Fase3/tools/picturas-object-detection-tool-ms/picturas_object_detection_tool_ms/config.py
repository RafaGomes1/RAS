...
RABBITMQ_REQUESTS_QUEUE_NAME = os.getenv("RABBITMQ_REQUESTS_QUEUE_NAME", "object-detection-requests")
...
PICTURAS_MS_NAME = os.getenv("PICTURAS_MS_NAME", "picturas-object-detection-tool-ms")
